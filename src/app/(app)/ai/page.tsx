...
const Page = () => {
  ...
  return (
    <div className='w-full max-md:px-4 h-screen flex flex-col px-52'>
        <Link href={"/dashboard"}  className='absolute max-md:left-10 left-20 w-10 h-10 rounded-full border-black border-[2px] flex items-center justify-center cursor-pointer max-md:top-9 top-10'>
            <ArrowLeft className='w-7  h-7'/>
        </Link>
      <h1 className=" text-5xl text-nowrap max-md:text-lg head-text self-center pt-10 ">Ask Ai how to Improve habits</h1>
      <div className='flex-1 mt-10 flex flex-col'>
        <div className='w-full h-[536px] max-md:h-full overflow-y-scroll scrollbar-hidden max-w-full flex flex-col'>
        ...
        <div className='w-full  h-20 fixed bottom-0 left-0 right-0 bg-zinc-50 flex items-center py-4 justify-center '>
            <div className='w-2/3 max-md:w-11/12 h-full flex bg-zinc-200 items-center justify-center rounded-full'>
